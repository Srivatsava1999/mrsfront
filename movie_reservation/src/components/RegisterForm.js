...
const RegisterForm=()=>{
    ...
    return (
        ...
        {message && <p>{message}</p>}
        <input type="email" placeholder="Email" name="email" value={register.email} class="input" onChange={handleChange}/>
        <input type="password" placeholder="Password" name="password" value={register.password} class="input" onChange={{handleChange}}/>
        <input type="text" placeholder="Name" name="name" value={register.name} class="input" onChange={{handleChange}}/>
        <input type="text" placeholder="Phone" name="phone" value={register.phone} class="input" onChange={{handleChange}}/>
        ...
        <button class="button-confirm" onClick={navigate("/register/")}>Log In</button>
        </form>
    );
};
